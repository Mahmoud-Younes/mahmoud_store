...
import 'package:mahmoud_store/core/styles/images/app_images.dart';
...
class MyAssets extends ThemeExtension<MyAssets> {
  ...
  @override
  ThemeExtension<MyAssets> copyWith({String? bigNavBar, String? homeBg}) {
    return MyAssets(bigNavBar: bigNavBar, homeBg: homeBg);
  }
